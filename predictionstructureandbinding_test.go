	...
	_, err := client.Predictions.StructureAndBinding.EstimateCost(context.TODO(), boltzapi.PredictionStructureAndBindingEstimateCostParams{
		Input: boltzapi.PredictionStructureAndBindingEstimateCostParamsInput{
			...
			Templates: []boltzapi.PredictionStructureAndBindingEstimateCostParamsInputTemplate{{
				...
				ForceThresholdAngstroms: boltzapi.Float(0),
			}},
		},
		Model:          "boltz-2.1",
...
func TestPredictionStructureAndBindingTokenCountWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Predictions.StructureAndBinding.TokenCount(context.TODO(), boltzapi.PredictionStructureAndBindingTokenCountParams{
		Input: boltzapi.PredictionStructureAndBindingTokenCountParamsInput{
			Entities: []boltzapi.PredictionStructureAndBindingTokenCountParamsInputEntityUnion{{
				OfPredictionStructureAndBindingTokenCountsInputEntityBoltz2ProteinEntity: &boltzapi.PredictionStructureAndBindingTokenCountParamsInputEntityBoltz2ProteinEntity{
					ChainIDs: []string{"string"},
					Value:    "value",
					Cyclic:   boltzapi.Bool(true),
					Modifications: []boltzapi.PredictionStructureAndBindingTokenCountParamsInputEntityBoltz2ProteinEntityModification{{
						ResidueIndex: 0,
						Value:        "value",
					}},
					Msa: boltzapi.PredictionStructureAndBindingTokenCountParamsInputEntityBoltz2ProteinEntityMsaUnion{
						OfPredictionStructureAndBindingTokenCountsInputEntityBoltz2ProteinEntityMsaBoltz2CustomMsa: &boltzapi.PredictionStructureAndBindingTokenCountParamsInputEntityBoltz2ProteinEntityMsaBoltz2CustomMsa{
							Format: boltzapi.PredictionStructureAndBindingTokenCountParamsInputEntityBoltz2ProteinEntityMsaBoltz2CustomMsaFormatA3m,
							Source: boltzapi.PredictionStructureAndBindingTokenCountParamsInputEntityBoltz2ProteinEntityMsaBoltz2CustomMsaSourceUnion{
								OfPredictionStructureAndBindingTokenCountsInputEntityBoltz2ProteinEntityMsaBoltz2CustomMsaSourceURLSource: &boltzapi.PredictionStructureAndBindingTokenCountParamsInputEntityBoltz2ProteinEntityMsaBoltz2CustomMsaSourceURLSource{
									URL: "https://example.com",
								},
							},
						},
			...
			Binding: boltzapi.PredictionStructureAndBindingTokenCountParamsInputBindingUnion{
				OfPredictionStructureAndBindingTokenCountsInputBindingLigandProteinBinding: &boltzapi.PredictionStructureAndBindingTokenCountParamsInputBindingLigandProteinBinding{
					BinderChainID: "binder_chain_id",
				},
			},
			Bonds: []boltzapi.PredictionStructureAndBindingTokenCountParamsInputBond{{
				Atom1: boltzapi.PredictionStructureAndBindingTokenCountParamsInputBondAtom1Union{
					OfPredictionStructureAndBindingTokenCountsInputBondAtom1LigandAtom: &boltzapi.PredictionStructureAndBindingTokenCountParamsInputBondAtom1LigandAtom{
						AtomName: "atom_name",
						ChainID:  "chain_id",
					},
				},
				Atom2: boltzapi.PredictionStructureAndBindingTokenCountParamsInputBondAtom2Union{
					OfPredictionStructureAndBindingTokenCountsInputBondAtom2LigandAtom: &boltzapi.PredictionStructureAndBindingTokenCountParamsInputBondAtom2LigandAtom{
						AtomName: "atom_name",
						ChainID:  "chain_id",
					},
				},
			}},
			Constraints: []boltzapi.PredictionStructureAndBindingTokenCountParamsInputConstraintUnion{{
				OfPredictionStructureAndBindingTokenCountsInputConstraintPocketConstraint: &boltzapi.PredictionStructureAndBindingTokenCountParamsInputConstraintPocketConstraint{
					BinderChainID: "binder_chain_id",
					ContactResidues: map[string][]int64{
						"A": {42, 43, 44, 67, 68, 69},
					},
			...
			ModelOptions: boltzapi.PredictionStructureAndBindingTokenCountParamsInputModelOptions{
				RecyclingSteps: boltzapi.Int(1),
				SamplingSteps:  boltzapi.Int(50),
				StepScale:      boltzapi.Float(1.3),
			},
			NumSamples: boltzapi.Int(1),
			Templates: []boltzapi.PredictionStructureAndBindingTokenCountParamsInputTemplate{{
				TemplateChains: []boltzapi.PredictionStructureAndBindingTokenCountParamsInputTemplateTemplateChain{{
					InputChainID:    "input_chain_id",
					TemplateChainID: "template_chain_id",
				}},
				TemplateStructure: boltzapi.PredictionStructureAndBindingTokenCountParamsInputTemplateTemplateStructureUnion{
					OfPredictionStructureAndBindingTokenCountsInputTemplateTemplateStructureURLSource: &boltzapi.PredictionStructureAndBindingTokenCountParamsInputTemplateTemplateStructureURLSource{
						URL: "https://example.com",
					},
				},
				ForceThresholdAngstroms: boltzapi.Float(0),
