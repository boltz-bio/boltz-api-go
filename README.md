...
```sh
go get -u 'github.com/boltz-bio/boltz-api-go@v0.20.0'
```
...
client.Predictions.StructureAndBinding.Start(context.TODO(), ...,
	// Override the header
...
for iter.Next() {
	...
	fmt.Printf("%+v\n", predictionStructureAndBindingListResponse)
}
...
if err != nil {
	...
	panic(err.Error()) // GET "/compute/v1/predictions/structure-and-binding": 400 Bad Request { ... }
}
```
