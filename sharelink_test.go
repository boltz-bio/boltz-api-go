...
func TestShareLinkNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.ShareLinks.New(context.TODO(), boltzapi.ShareLinkNewParams{
		...
		AccessParameters: boltzapi.ShareLinkNewParamsAccessParametersUnion{
			OfShareLinkNewsAccessParametersPublicShareLinkAccessParameters: &boltzapi.ShareLinkNewParamsAccessParametersPublicShareLinkAccessParameters{},
		},
...
func TestShareLinkArchive(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.ShareLinks.Archive(context.TODO(), "shr_qoEFr2BlPTBLuM5BinaC8x7iVPP_AwppEOmlxQjJ-eo")
	if err != nil {
		var apierr *boltzapi.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestShareLinkRead(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.ShareLinks.Read(context.TODO(), "shr_qoEFr2BlPTBLuM5BinaC8x7iVPP_AwppEOmlxQjJ-eo")
	if err != nil {
		var apierr *boltzapi.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
